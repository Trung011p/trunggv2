...
IQ:AddToggle({
    Name = "Tự động Ectoplasm",
    Default = false,
    Flag = "Tự động Ectoplasm",
    Save = true,
    Callback = function(Value)
...
spawn(function()
    ...
    if _G.AutoEctoplasm and World2 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Ectoplasm") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    topos(CFrame.new(1037.80127, 125.092171, 32911.6016, 1212.0111083984375, 150.79205322265625, 33059.24609375, 1037.80127, 125.092171, 32911.6016, 919.4786376953125, 43.54401397705078, 32779.96875,968.80957, 125.092171, 33244.125,919.4385375976562, 129.55599975585938, 33436.03515625,968.80957, 125.092171, 33244.125
,1036.0179443359375, 181.4390411376953, 33315.7265625)  
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Vampire") then
                            topos(game:GetService("ReplicatedStorage"):FindFirstChild("Vampire").HumanoidRootPart.CFrame * CFrame.new(0,20,0))
                        else
